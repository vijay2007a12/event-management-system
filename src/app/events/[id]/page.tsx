...
import { FiArrowLeft, FiCalendar, FiMapPin, FiUsers, FiDollarSign, FiMic, FiCoffee, FiGift, FiShare2 } from 'react-icons/fi';
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="aspect-video bg-gradient-to-br from-purple-600/20 to-cyan-600/20 flex items-center justify-center">
            <FiCalendar className="text-purple-300" size={96} />
          </div>
